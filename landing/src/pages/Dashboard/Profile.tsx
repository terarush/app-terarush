        ...
        <div className="grid gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add a banner image to your profile</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground">
                JPG, PNG or GIF (max. 10MB). Recommended size: 1200x300px
              </p>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full mt-1.5 px-3 py-2 border border-input rounded-md bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                      maxLength={500}
                      rows={4}
                    />
                    <p className="text-xs text-muted-foreground mt-1.5">
