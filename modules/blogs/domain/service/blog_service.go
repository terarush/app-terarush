...
// GetAllBlogsWithPagination gets all blogs with pagination
func (s *BlogService) GetAllBlogsWithPagination(ctx context.Context, page, pageSize int) ([]*entity.Blog, int64, error) {
